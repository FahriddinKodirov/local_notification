...
import 'package:local_notification/screen/new_screen.dart';
    ...
    flutterLocalNotificationsPlugin.show(
      ...
      NotificationDetails(
        android: AndroidNotificationDetails(
          ...
          icon: "tick_icon",
          showProgress: true,
          largeIcon: const DrawableResourceAndroidBitmap('tick_icon'),
        ),
      ),
    ...
    flutterLocalNotificationsPlugin.show(
      ...
      NotificationDetails(
        android: AndroidNotificationDetails(
          ...
          icon: "error_icon",
          showProgress: true,
          largeIcon: const DrawableResourceAndroidBitmap('error_icon'),
        ),
      ),
      payload: "SIMPLE NOTIFICATION DATA ID:$id",
    );
